...
int main_sdl(void) {
	//todo CHANGE TITLE IN SDL_CREATE_WINDOW
	SDL_Event e;
...
//	SDL_Surface *w  = SDL_SetVideoMode(WIN_W, WIN_H, 0, SDL_HWSURFACE | SDL_DOUBLEBUF);
	SDL_Window *s = SDL_CreateWindow("TOCHANGE",
	...
	if (SDL_SetColorKey(img, SDL_TRUE , SDL_MapRGB(img->format, 0, 0, 255)) != 0) {
